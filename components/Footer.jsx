      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-2xl font-bold tracking-tight text-white">
                <span className="relative px-8 py-2 text-2xl font-semibold text-orange-500 hover:text-orange-600 transition-colors group">Rutas del sabor</span>
              </h2>
            </div>
            ...
            <ul className="space-y-4 ">
              <li className="flex items-start space-x-3 text-orange-300">
                <span className="material-icons-outlined text-orange-500 text-xl">place</span>
              ...
              <li className="flex items-center space-x-3 text-orange-300">
                <span className="material-icons-outlined text-orange-500 text-xl">phone</span>
                <span className="text-sm text-slate-600">+52 (555) 123-4567</span>
              </li>
              <li className="flex items-center space-x-3 text-orange-300">
                <span className="material-icons-outlined text-orange-500 text-xl">email</span>
          ...
          <div className="lg:pl-8">
            <h3 className="relative px-4 py-2 text-lg font-semibold text-orange-500 hover:text-orange-600 transition-colors group">
              Explorar
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 ">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-orange-500/10 hover:bg-orange-500 text-orange-500 hover:text-white rounded-lg flex items-center justify-center transition-all duration-300"
              >
